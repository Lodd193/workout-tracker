...
-- ============================================
-- This script creates realistic test data for a user over 3 months
...
-- ============================================
-- Progressive overload across 12 weeks (3 months)
-- Push/Pull/Legs split, 6 days per week
-- Realistic progression with occasional deload weeks
